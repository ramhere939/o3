    ...
    >
      <Link to={`/buyer/product/${product.id}`} state={{ product }} className="block">
        <div className="h-40 bg-slate-100 flex items-center justify-center relative overflow-hidden group-hover:bg-slate-200 transition-colors">
          <div className="absolute top-2 right-2 flex flex-col gap-1.5 z-10 w-12">
            <div className="w-full bg-white/90 backdrop-blur py-1 rounded text-[10px] font-bold text-slate-600 flex items-center justify-center gap-1 shadow-sm">
            ...
            <button
              ...
              className="w-full bg-white/90 backdrop-blur py-1.5 rounded text-[10px] font-bold text-indigo-600 flex items-center justify-center shadow-sm hover:bg-indigo-50 hover:text-indigo-700 transition-colors"
